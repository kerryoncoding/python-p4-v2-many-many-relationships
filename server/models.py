...
# Association/Join table to store many-to-many relationship between employees and meetings
...
class Employee(db.Model):
    ...
    # Association proxy to get projects for this employee through assignmets
...
class Project(db.Model):
    ...
    # Association proxy to get employees for this project through assignmets
